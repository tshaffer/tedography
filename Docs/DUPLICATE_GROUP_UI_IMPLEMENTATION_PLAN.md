...
- implemented duplicate visibility refresh integration for the new group UI using the existing
  `duplicateVisibilityRefresh.ts` override/request path
- Library `Keeper` / `Duplicate` visibility can now update promptly after group resolve/reopen
